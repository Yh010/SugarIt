        ...
        <div >
            <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-3" style={{textAlign:'justify'}}>Your feedback fuels our flavor journey! Share your thoughts with Sugarit – together, let's cook up something amazing! Thanks for being part of the sweetness!</p>
                    <div class="mt-12">
